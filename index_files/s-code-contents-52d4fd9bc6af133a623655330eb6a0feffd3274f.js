...
*/
AppMeasurement.prototype.getVisitNum=new Function("tp","c","c2",""
...
AppMeasurement.prototype.dimo=new Function("m","y",""
                                           +"var d=new Date(y,m+1,0);return d.getDate();");
AppMeasurement.prototype.endof=new Function("x",""
...
*/
AppMeasurement.prototype.getDaysSinceLastVisit=new Function("c",""
 ...
 */
AppMeasurement.prototype.getValOnce=new Function("v","c","e",""
                                                 +"var s=this,k=s.c_r(c),a=new Date;e=e?e:0;if(v){a.setTime(a.getTime("
                                                 +")+e*86400000);s.c_w(c,v,e?a:0);}return v==k?'':v");
//Plugin Utility: Replace v1.0
AppMeasurement.prototype.repl = new Function("x", "o", "n", "var i=x.indexOf(o),l=n.length;while(x&&i>=0){x=x.substring(0,i)+n+x.substring(i+o.length);i=x.indexOf(o,i+l)}return x");
/*
 ...
 */
AppMeasurement.prototype.getPercentPageViewed=new Function("n",""
 ...
 */
AppMeasurement.prototype.getPreviousValue=new Function("v","c","el",""
 ...
 */
AppMeasurement.prototype.getTimeParting=new Function("t","z","y",""
...
AppMeasurement.prototype.crossVisitParticipation = new Function("v", "cn", "ex", "ct", "dl", "ev", "dv", "var s=this,ce;if(typeof(dv)==='undefined')dv=0;if(s.events&&ev){var ay=s.split(ev,',');var ea=s.split(s.events,',');for(var u=0;u<ay.length;u++){for(var x=0;x<ea.length;x++){if(ay[u]==ea[x]){ce=1;}}}}if(!v||v==''){if(ce){s.c_w(cn,'');return'';}else return'';}v=escape(v);var arry=new Array(),a=new Array(),c=s.c_r(cn),g=0,h=new Array();if(c&&c!=''){arry=s.split(c,'],[');for(q=0;q<arry.length;q++){z=arry[q];z=s.repl(z,'[','');z=s.repl(z,']','');z=s.repl(z,\"'\",'');arry[q]=s.split(z,',')}}var e=new Date();e.setFullYear(e.getFullYear()+5);if(dv==0&&arry.length>0&&arry[arry.length-1][0]==v)arry[arry.length-1]=[v,new Date().getTime()];else arry[arry.length]=[v,new Date().getTime()];var start=arry.length-ct<0?0:arry.length-ct;var td=new Date();for(var x=start;x<arry.length;x++){var diff=Math.round((td.getTime()-arry[x][1])/86400000);if(diff<ex){h[g]=unescape(arry[x][0]);a[g]=[arry[x][0],arry[x][1]];g++;}}var data=s.join(a,{delim:',',front:'[',back:']',wrap:\"'\"});s.c_w(cn,data,e);var r=s.join(h,{delim:dl});if(ce)s.c_w(cn,'');return r;");

var sc = s_gi(_satellite.getToolsByType('sc')[0].settings.account);

if(window.Visitor)
  sc.visitor = Visitor.getInstance('8CF467C25245AE3F0A490D4C@AdobeOrg');
sc.linkInternalFilters="javascript:,admeld.com,rottentomatoes.com,www.facebook.com/plugins/like.php,rottentomatoes,www.rottentomatoes.com,"+window.location.hostname;
sc.visitorNamespace="warnerbros";
sc.trackingServer="warnerbros.112.2o7.net";

sc.getRwd=new Function("rwd","phoneMax","desktopMin",""
...
sc.registerPostTrackCallback(function(){
  sc.c_w('s_prevPage', sc.pageName);
});

sc.usePlugins = true;
sc.doPlugins = function(s){
  // from legacy s_code
  s.campaign = s.Util.getQueryParam('adid');
  if(!s.campaign)
    s.campaign = s.Util.getQueryParam('promo');
  if(!s.campaign)
    s.campaign = s.Util.getQueryParam('ref');
  s.campaign = s.getValOnce(s.campaign,"s_campaign",0);
  s.linkLeaveQueryString=false;

  s.eVar79 = s.c_r('aam_uuid');

  // visitor info
  if(!s.eVar10)
    s.eVar10 = s.pageName;
  if(!s.prop26){
    s.prop26 = s.getVisitNum(30);
    s.eVar26 = s.prop26;
  ...
  // previous page
  if(!s.prop5)
	  s.prop5 = s.c_r('s_prevPage');
  if(!s.eVar37)
	  s.eVar37 = s.prop5;

  // day of week
  if(!s.prop25)
	  s.prop25 = _satellite.getVar('Day of Week');
  if(!s.eVar25)
  s.eVar25 = s.prop25;

  if(s.customDoPlugins)
    s.customDoPlugins(s);
}
